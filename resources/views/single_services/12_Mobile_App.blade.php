 ...
 <section class="page-title">
            <div class="container">
                <ul class="breadcrumb unstyled">
                    ...
                    <li class="active"><a href="!#">Mobile Application Development</a></li>
                </ul>
                <h1 class="mb-0 color-dark-2">Mobile Application Development</h1>
                <h3>Detail</h3>
            </div>
</section>
...
<section class="services-detail mt-100 mb-48 container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <h1 class="fs-53 fw-7 color-dark-2">Mobile Application Development</h1>
                    <div class="row">
                        <div class="col-lg-7">
                            <h1 alt="Get Noticed, Stay Relevant">Mobile Experiences that Engage</h1>
                            <p class="ps-5">Create a mobile app that strengthens your customer connections. We build user-friendly, high-performing apps that align with your brand and make engaging with your business a breeze.
                            </p>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-9 offset-lg-0">
                            <h2 class="fs-53 color-dark-2">What Do We Dig Into?</h2>
                            <div class="row">
                                <div class="col-lg-12 col-sm-6">
                                    <ul class="unstyled points">
                                        <li class="fs-24">Intuitive design for optimal user experience</li>
                                        <li class="fs-24">Cross-platform compatibility (iOS & Android)</li>
                                         <li class="fs-24">Performance tracking and regular updates</li>
                                        <li class="fs-24">Secure payment, messaging, and push notification features</li>
                                    </ul>
                                </div>
