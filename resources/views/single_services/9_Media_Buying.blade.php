 ...
 <section class="page-title">
            <div class="container">
                <ul class="breadcrumb unstyled">
                    ...
                    <li class="active"><a href="!#">Digital Media Buying</a></li>
                </ul>
                <h1 class="mb-0 color-dark-2">Digital Media Buying</h1>
                <h3>Detail</h3>
            </div>
</section>
...
<section class="services-detail mt-100 mb-48 container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <h1 class="fs-53 fw-7 color-dark-2">Digital Media Buying</h1>
                    <div class="row">
                        <div class="col-lg-7">
                            <h1 alt="Get Noticed, Stay Relevant">Reach Your Audience, Maximize ROI</h1>
                            <p class="ps-5">Elevate your digital reach with precision media buying. Through careful targeting and real-time adjustments, we ensure your budget drives impact where it matters most.
                            </p>
                        </div>
                    </div>
                    <div class="row mt-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-6">
                                    <ul class="unstyled points">
                                        <li class="fs-24">Audience segmentation for optimized targeting</li>
                                        <li class="fs-24">Data-driven ad placements across platforms</li>
                                         <li class="fs-24">Campaign adjustments to maximize conversions</li>
                                        <li class="fs-24">Clear, detailed reporting on budget use and results</li>
                                    </ul>
                                </div>
