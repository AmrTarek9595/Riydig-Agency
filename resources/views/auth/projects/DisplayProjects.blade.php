...
<td>{{ $datas->project_title }}</td>
<td>{{ $datas->type }}</td>
<td><img src="/images/projects/{{$datas->image_name}}" style="width:100px;height:100px;"></td>





<td><a href="/updateProject/{{$datas->id}}" class="mb-2 mr-2 btn-hover-shine btn btn-shadow btn-success"><i class="lnr-license btn-icon-wrapper"> </i>Update</a></td>

<td>
    <form action="/deleteProject/{{$datas->id}}" method="POST">
        @csrf
