...
<div>Edit Service
<div class="page-title-subheading">Edit Current  Service</div>
</div>
</div>
 </div>
...
<form class="" method="POST"  action="/UpdateService_post/{{$data->id}}" enctype='multipart/form-data'>
@csrf
...
<div class="col-sm-10">
<textarea name="quotation_en" id="quotation_en" class="form-control"> {{$data->quotation_en}}</textarea>
</div>

</div>

<div class="position-relative row form-group">
<label for="exampleText" class="col-sm-2 col-form-label">Service Body</label>
<div class="col-sm-10">
...
<img src="/images/{{$data->image_name}}" alt="Image Preview" style="width: 200px;height: 200px;">
